 ...
 ******************************************************************************/
    ...
    https: {
      key: require("fs").readFileSync('/etc/letsencrypt/live/petificationblue.ddns.net/privkey.pem'),
      cert: require("fs").readFileSync('/etc/letsencrypt/live/petificationblue.ddns.net/cert.pem')
    },
